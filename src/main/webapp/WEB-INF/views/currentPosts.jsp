		...
		<div id="navbar" class="navbar navbar-default    navbar-collapse">
			...
			<div class="navbar-header pull-center-left">
				...
				<div class="navbar-header pull-left">
					...
					<a href="${linkedinURL}" class="navbar-brand">
					<small>
							
							Redirect to Linkedin profile of ${name}
		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<br>
				           ...
				           <img width=150 height=150 style="square"
					              	src="${linkedinPicture}" />
					<br><br>
                                   <button type="button" class="btn btn-white btn-primary" disabled>
									
										<font color="black">Farouk Jomma &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</font>
									</button>
						
				                  	<button type="button" class="btn btn-white btn-primary" disabled>
										
										<font color="black">Khaled Ben Driss &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</font>
									</button>
									
									<button type="button" class="btn btn-white btn-primary" disabled>
										
										<font color="black">Yassine Ben Naceur &nbsp &nbsp &nbsp &nbsp &nbsp</font>
									</button>
			...
			<div class="main-content">
				...
				<div id="sidebar2" class="sidebar h-sidebar navbar-collapse collapse">
										<ul class="nav nav-list">
										      ...
										      <li class="hover">
												<a class="dropdown-toggle" href="<%=request.getContextPath()%>/research/">
							...
							<c:forEach items="${posts}" var="ps">
								<form class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ps.title}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ps.company}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="col-sm-9">
										<textarea class="form-control" rows="3" disabled>${ps.description}</textarea>
										</div>
</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ps.duration}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ps.start_date}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
										...
										<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Linkedin company URL  </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ps.linkedin_company_url}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ps.website}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Industry </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ps.industry}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ps.type}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Headquarters </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ps.headquarters}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Company size</label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ps.company_size}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ps.address}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
...
<![endif]-->
		...
		<script src="<%=request.getContextPath()%>/resources/assets/js/jquery.bootstrap-duallistbox.js"></script>
		<script src="<%=request.getContextPath()%>/resources/assets/js/jquery.raty.js"></script>
		<script src="<%=request.getContextPath()%>/resources/assets/js/bootstrap-multiselect.js"></script>
		<script src="<%=request.getContextPath()%>/resources/assets/js/select2.js"></script>
		<script src="<%=request.getContextPath()%>/resources/assets/js/typeahead.jquery.js"></script>
		...
		<script src="<%=request.getContextPath()%>/resources/assets/js/ace/elements.fileinput.js"></script>
		<script src="<%=request.getContextPath()%>/resources/assets/js/ace/elements.typeahead.js"></script>
		<script src="<%=request.getContextPath()%>/resources/assets/js/ace/elements.wysiwyg.js"></script>
		...
		<script src="<%=request.getContextPath()%>/resources/assets/js/ace/ace.widget-box.js"></script>
		<script src="<%=request.getContextPath()%>/resources/assets/js/ace/ace.settings.js"></script>
		<script src="<%=request.getContextPath()%>/resources/assets/js/ace/ace.settings-rtl.js"></script>
		...
		<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/assets/css/ace.onpage-help.css" />
		<link rel="stylesheet" href="../docs/assets/js/themes/sunburst.css" />

		<script type="text/javascript"> ace.vars['base'] = '..'; </script>
		<script src="<%=request.getContextPath()%>/resources/assets/js/ace/elements.onpage-help.js"></script>
		<script src="<%=request.getContextPath()%>/resources/assets/js/ace/ace.onpage-help.js"></script>
