			...
			<div class="main-content-inner">
				<div class="page-content">
					...
					<div class="page-header">
						<h1>Recommanded visitors of ${name}</h1>
					</div>
					<!-- /.page-header -->
...
<li class="hover">
							...
							<div class="col-xs-12">
								<c:forEach items="${allRecommandedVisitors}" var="rc">
									<form class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" id="form-field-1" value="${rc.title}"
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right"
												for="form-field-1"> Link </label>

											<div class="col-sm-9">
												<input type="text" id="form-field-1" value="${rc.link}"
													class="col-xs-10 col-sm-5" disabled>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" id="form-field-1" value="${rc.name}"
													class="col-xs-10 col-sm-5" disabled>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" id="form-field-1" value="${rc.company}"
													class="col-xs-10 col-sm-5" disabled>
											</div>
										</div>
