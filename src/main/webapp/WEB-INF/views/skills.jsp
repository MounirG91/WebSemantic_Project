				...
				<div id="sidebar2" class="sidebar h-sidebar navbar-collapse collapse">
								...
								<form class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${sk.name}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Date of first version </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${sk.firstAppeared}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Last version </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${sk.lastVersion}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${sk.designedBy}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
										...
										<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Developer </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${sk.developer}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${sk.licence}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${sk.website}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
