			...
			<div class="main-content">
				...
				<div id="sidebar2" class="sidebar h-sidebar navbar-collapse collapse">
								...
								<form class="form-horizontal">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Major </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ed.major}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ed.start_date}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${ed.end_date}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
