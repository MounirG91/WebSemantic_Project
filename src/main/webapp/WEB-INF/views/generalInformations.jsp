			...
			<div class="main-content-inner">
				<div class="page-content">
					...
					<div class="page-header">
						<h1>General informations of ${name}</h1>
					</div>
					<!-- /.page-header -->
							...
							<div class="col-xs-12">
								<form class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${firstName}"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${lastName}"
												class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${location}"
												class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${title}"
												class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"
											for="form-field-1"> Number of connections </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1"
												value="${numberOfConnections}" class="col-xs-10 col-sm-5"
												disabled>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"
											for="form-field-1"> Industry </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${industry}"
												class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="form-control" rows="3" disabled>${summary}</textarea>
										</div>
									</div>
