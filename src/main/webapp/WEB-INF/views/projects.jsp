		...
		<div class="main-container" id="main-container">
			...
			<div class="main-content">
				...
				<div id="sidebar2" class="sidebar h-sidebar navbar-collapse collapse">
								...
								<c:forEach items="${allProjects}" var="pr">
								<form class="form-horizontal">
									<!-- #section:elements.form -->
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${pr.title}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${pr.link}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${pr.start_date}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${pr.end_date}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${pr.duration}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
