...
<body class="no-skin">
 ...
 <li class="hover">
										...
										<li class="hover"><a href="#"> <span
											...
											<ul class="submenu">
												<li class="hover"><a
													href="<%=request.getContextPath()%>/generalInformations">
														<i class="menu-icon fa fa-caret-right"></i> General
														informations
												</a> <b class="arrow"></b></li>

												<li class="hover"><a
													href="<%=request.getContextPath()%>/educations"> <i
														class="menu-icon fa fa-caret-right"></i> Educations
												</a> <b class="arrow"></b></li>
												...
												<li class="hover"><a
													href="<%=request.getContextPath()%>/currentPosts"> <i
														class="menu-icon fa fa-caret-right"></i> Current Posts
												</a> <b class="arrow"></b></li>

												<li class="hover"><a
													href="<%=request.getContextPath()%>/pastPosts"> <i
														class="menu-icon fa fa-caret-right"></i> Past Posts
												</a> <b class="arrow"></b></li>

												<li class="hover"><a
													href="<%=request.getContextPath()%>/projects"> <i
														class="menu-icon fa fa-caret-right"></i> Projects
												</a> <b class="arrow"></b></li>

												<li class="hover"><a
													href="<%=request.getContextPath()%>/certifications"> <i
														class="menu-icon fa fa-caret-right"></i> Certfications
												</a> <b class="arrow"></b></li>

												<li class="hover"><a
													href="<%=request.getContextPath()%>/recommandedVisitors">
														<i class="menu-icon fa fa-caret-right"></i> Recommanded
														visitors
												</a> <b class="arrow"></b></li>

												<li class="hover"><a
													href="<%=request.getContextPath()%>/friends"> <i
														class="menu-icon fa fa-caret-right"></i> Friends
												</a> <b class="arrow"></b></li>

												<li class="hover"><a
													href="<%=request.getContextPath()%>/groups"> <i
														class="menu-icon fa fa-caret-right"></i> Groups
												</a> <b class="arrow"></b></li>
