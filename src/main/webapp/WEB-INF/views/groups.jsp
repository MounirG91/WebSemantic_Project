				...
				<div id="sidebar2" class="sidebar h-sidebar navbar-collapse collapse">
								...
								<form class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${gr.name}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${gr.link}" class="col-xs-10 col-sm-5" disabled>
										</div>
									</div>
